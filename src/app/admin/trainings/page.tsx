  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="font-heading text-3xl font-bold">Trainings & Special Trails</h1>
          <p className="text-muted mt-1">Manage training sessions and location-based special trails</p>
        </div>
