...
export const landingPages: Record<string, LandingPageData> = {
  "off-road-training-bangalore": {
    ...
    intro:
      "DRC — Dirt Ride Camp runs Bangalore's premier off-road motorcycle academy. Whether you have never left tarmac or you're chasing technical enduro lines, our structured, coach-led training builds real dirt-riding control step by step. Small groups, experienced instructors, and a safety-first approach — just beyond the city.",
    sections: [
      {
      ...
      },
      {
        ...
        body:
          "Complete beginners nervous about dirt, road riders wanting to explore adventure/ADV riding, and experienced riders sharpening technical skills are all welcome. We match the difficulty to your assessed level so you're always challenged but safe.",
      },
    ],
    faqs: [
      {
    ...
    ctaTitle: "Ready to ride the dirt?",
    ...
    sections: [
      {
        ...
        bullets: [
          ...
          "Scenic dirt sections, hills, and natural terrain",
